...
public final class MessageKey {
    ...
    public static final String USER_EMAIL_UNAVAILABLE = "user.error.email-unavailable";
    public static final String USER_HANDLE_UNAVAILABLE = "user.error.handle-unavailable";
